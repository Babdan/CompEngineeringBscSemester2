//By Bogdan Itsam Dorantes-Nikolaev, COMP110 Lab, Instructor: Mustafa Ersen (April 10th, 2022)
...
abstract class Shape extends Object implements Comparable<Shape> {
	
	interface Comparable<Shape>{
   ...
   public int compareTo(Shape s) {
	   if(s.computeArea() > this.computeArea())
	   return -1;
	   if(s.computeArea() < this.computeArea())
		   return 1;
	   return 0;
...
// A method for drawing shapes. As how to draw a shape depends on whether it
   ...
   public abstract String toString(Shape shape1);
...
class Circle extends Shape {
   ...
   @Override   
   	public String toString(Shape obj) {
	   
	   	return String.format("%.4f is the area of the Circle", obj.computeArea());
   }
...
class Rectangle extends Shape {
   ...
   public String toString(Shape obj) {
	   ...
	   return String.format("%.4f is the area of the rectangle", obj.computeArea());
   }
